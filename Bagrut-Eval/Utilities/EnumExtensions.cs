// File: Bagrut_Eval/Utilities/EnumExtensions.cs (or similar path)
...
namespace Bagrut_Eval.Utilities // IMPORTANT: Adjust this namespace to match your project's Utilities or Helpers folder
{
