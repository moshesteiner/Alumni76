...
using Microsoft.AspNetCore.Http; // ⭐ NEW: Add this for IFormFileCollection
using Microsoft.AspNetCore.Mvc;
using Microsoft.AspNetCore.Mvc.RazorPages;
using Microsoft.AspNetCore.Mvc.Rendering;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.Configuration; // ⭐ NEW: Add this for IConfiguration
...
namespace Bagrut_Eval.Pages
{
    ...
    public class AddIssueModel : BasePageModel<AddIssueModel>
    {
        ...
        // ⭐ NEW PROPERTY: To bind the uploaded files from the form
        [BindProperty]
        public IFormFileCollection? NewIssueDrawings { get; set; }
        private const int MaxDrawingsPerIssue = 3;
        //public double maxFileSizeinMB = 1.0;

        public AddIssueModel(ApplicationDbContext dbContext, ILogger<AddIssueModel> logger,
        ...
        private async Task<IActionResult> HandleFileUploadsAsync()
        {
            ...
            long maxFileSizePerFile = (long)(ReportModel.maxFileSizeinMB * 1024 * 1024); // Example: 1 MB per file. Adjust as needed.
        ...
        private async Task<IActionResult> SaveIssueToDatabaseAsync()
        {
            ...
            try
            {
                ...
                // ⭐ SUCCESS: Redirect to the Report page, filtered for 'My Reports'
                return RedirectToPage("/Report", new { IsMyReportSelected = true, SelectedExamId=SelectedExamId });
            }
        ...
        private async Task LoadDataAsync()
        {
            ...
            if (SelectedExamId.HasValue)
            {
                ...
                Issues = await issuesQuery
                                        .OrderBy(i => i.QuestionNumber)
                                        .ThenBy(i => i.Part == null ? null : i.Part.QuestionPart)
                                        .ThenByDescending(i => i.Status)
                                        .ToListAsync();
